...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[var(--theme-bg)] text-[var(--theme-text-main)] flex flex-col font-sans select-none selection:bg-[var(--theme-accent-light)]">
      ...
      <header className="border-b border-[var(--theme-border)]/45 bg-[var(--theme-card)]/80 backdrop-blur-md sticky top-0 z-50 px-6 py-2.5 flex items-center justify-between transition-all duration-300">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-[var(--theme-accent)] to-[var(--theme-text-dark)] flex items-center justify-center mr-1 text-white border-none shadow-xs">
            <span className="font-semibold text-xs font-sans tracking-tight">CFA</span>
          </div>
          <div>
            <h1 className="text-sm font-semibold text-[var(--theme-text-dark)] tracking-tight flex items-center gap-2">
              Level I Prep Tracker
              <span className="text-[9px] bg-[var(--theme-beige)] text-[var(--theme-accent)] font-medium px-2 py-0.5 rounded-full select-none">
                93 Modules
              </span>
            </h1>
            <p className="text-[10px] text-[var(--theme-text-main)] opacity-70 font-normal">Track Smart, Prep Better.</p>
          </div>
        </div>
        ...
        {signedIn && (
          <div className="flex items-center gap-3.5">
            <div className="hidden sm:flex flex-col text-right">
              <span className="text-xs text-[var(--theme-text-dark)] font-medium">{userProfile.email}</span>
              <span className="text-[9px] text-[var(--theme-text-main)] opacity-75">CFA Level I Candidate</span>
            </div>
            ...
            <button
              ...
              className="bg-[var(--theme-beige)] hover:bg-[var(--theme-beige-dark)]/50 border border-[var(--theme-border)]/40 hover:border-[var(--theme-border)] text-[var(--theme-text-dark)] px-3 py-1.5 rounded-xl text-xs font-medium select-none flex items-center gap-1.5 transition-all duration-300 hover:-translate-y-[1px] active:scale-98 cursor-pointer"
            >
      ...
      {!signedIn ? (
        ...
        <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 space-y-8">
          ...
          <div className="flex border-b border-[var(--theme-border)]/20 overflow-x-auto scrollbar-none whitespace-nowrap gap-6 sm:gap-8">
            <button
