...
export default function GrowthTree({ subjects, progress, totalStudyTime, isDashboard = false }: GrowthTreeProps) {
  ...
  return (
    <div className="bg-[var(--theme-card)] border border-[var(--theme-border)]/50 rounded-2xl p-7 text-[var(--theme-text-dark)] shadow-sm relative overflow-hidden font-sans transition-all duration-300 hover:shadow-md">
