    ...
    <>
      <div className="space-y-6 md:space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Countdown card */}
          <SpotlightCard className="bg-[var(--theme-card)] border border-[var(--theme-border)]/15 p-6 relative overflow-hidden transition-all duration-300 shadow-[var(--theme-shadow)] hover:shadow-[var(--theme-shadow-hover)] hover:-translate-y-[1.5px] h-full" borderRadius="24px">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Weak Areas Alerts */}
          <SpotlightCard className="bg-[var(--theme-card)] border border-[var(--theme-border)]/15 p-7 flex flex-col transition-all duration-300 shadow-[var(--theme-shadow)] hover:shadow-[var(--theme-shadow-hover)] hover:-translate-y-[1.5px]" borderRadius="24px">
          ...
          <SpotlightCard className="bg-[var(--theme-card)] border border-[var(--theme-border)]/15 p-7 md:col-span-2 flex flex-col transition-all duration-300 shadow-[var(--theme-shadow)] hover:shadow-[var(--theme-shadow-hover)] hover:-translate-y-[1.5px]" borderRadius="24px">
            <h3 className="text-sm font-semibold text-[var(--theme-text-dark)] mb-5 border-b border-[var(--theme-border)]/30 pb-3">
