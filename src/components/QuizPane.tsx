...
export default function QuizPane({ subjects, progress, onRecordQuizScore, targetExamDate }: QuizPaneProps) {
  ...
  const fetchQuestion = async (subjId: string, diff: Difficulty) => {
    ...
    setTimeout(() => {
      try {
        const quest = getProceduralQuestion(subjId, diff, targetExamDate);
  ...
  return (
    <div className="space-y-6">
      ...
      <SpotlightCard className="bg-[var(--theme-card)] border border-[var(--theme-border)]/15 p-6 shadow-[var(--theme-shadow)]" borderRadius="24px">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <SpotlightCard className="bg-[var(--theme-card)] border border-[var(--theme-border)]/15 p-6 shadow-[var(--theme-shadow)] hover:shadow-[var(--theme-shadow-hover)] lg:col-span-2 relative min-h-[400px] flex flex-col justify-between transition-all duration-300" borderRadius="24px">
        ...
        <div className="space-y-4">
          ...
          <SpotlightCard className="bg-[var(--theme-card)] border border-[var(--theme-border)]/15 p-5 shadow-[var(--theme-shadow)]" borderRadius="24px">
          ...
          {answered && currentQuestion && (
            <SpotlightCard className="bg-[var(--theme-card)] border border-[var(--theme-border)]/15 p-5 shadow-[var(--theme-shadow)] animate-fadeIn max-h-[340px] overflow-y-auto" borderRadius="24px">
          ...
          {/* Instruction helper */}
          {!answered && (
            <SpotlightCard className="bg-[var(--theme-card)] border border-[var(--theme-border)]/15 p-6 text-center text-xs text-[var(--theme-text-main)] py-8 shadow-[var(--theme-shadow)]" borderRadius="24px">
