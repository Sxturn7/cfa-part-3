  ...
  return (
    <>
      <motion.div
        ...
        style={{
          scale,
          opacity: useTransform(scale, [1, 1.2], [0.85, 1])
        }}
      ...
      >
        <motion.div
          ...
          className="flex items-center justify-center text-[var(--theme-text-main)] hover:text-[var(--theme-text-dark)] transition-colors"
        >
          {leftIcon}
        </motion.div>
